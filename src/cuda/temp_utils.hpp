...
namespace kfusion
{
        namespace device
        {
                ...
                template<> struct numeric_limits<float>
                {
                                ...
                                ;__kf_device__ static float min()
                                {
                                        return 1.175494351e-38f/*FLT_MIN*/;
                                }
                                ;__kf_device__ static float max()
                                {
                ...
                {
                                __kf_device__ static unsigned short max()
                                {
                                        return USHRT_MAX;
                                }
                                ;
                ...
                struct Eigen33
                {
                        public:
                                ...
                                {
                                                float3 data[Rows];__kf_hdevice__ float3& operator[](int i)
                                                {
                                                        return data[i];
                                                }
