        ...
        namespace device
        {
                ...
                struct TsdfVolume
                {
                        public:
                                ...
                                __kf_device__ elem_type* operator()(int x, int y, int z);__kf_device__ const elem_type* operator()(int x, int y, int z) const;__kf_device__ elem_type* beg(int x, int y) const;__kf_device__ elem_type* zstep(elem_type * const ptr) const;
                        private:
                ...
                struct Projector
                {
                                ...
                                Projector(float fx, float fy, float cx, float cy);__kf_device__ float2 operator()(const float3& p) const;
                };
                ...
                struct Reprojector
                {
                                ...
                                float2 finv, c;__kf_device__ float3 operator()(int x, int y, float z) const;
                };
                ...
                struct ComputeIcpHelper
                {
                                ...
                                //private:
                                __kf_device__ int find_coresp(int x, int y, float3& n, float3& d, float3& s) const;__kf_device__ void partial_reduce(const float row[7], PtrStep<float>& partial_buffer) const;__kf_device__ float2 proj(const float3& p) const;__kf_device__ float3 reproj(float x, float y, float z) const;
                };
