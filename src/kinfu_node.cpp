...
struct KinFuNode
{
                ...
                KinFuNode(RosRGBDCamera* camera, const std::string& fixedFrame, const std::string& camFrame) :
                                exit_(false), iteractive_mode_(false), camera_(camera), baseFrame(fixedFrame), cameraFrame(camFrame)
                {
